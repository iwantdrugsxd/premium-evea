-- FIXED DEBUG SCRIPT - Based on actual schema
...
-- Insert test event if missing (using correct schema)
INSERT INTO public.events (name, description, icon, features, avg_budget, duration, team_size)
VALUES ('Wedding', 'Complete wedding planning services', 'heart', ARRAY['Full Planning', '500+ Vendors', 'Premium Service'], '500000', '6-12 months', '5-10 people')
ON CONFLICT DO NOTHING
