...
INSERT INTO public.events (name, description, icon, features, avg_budget, duration, team_size) VALUES
...
-- Add sample event packages
INSERT INTO public.event_packages (event_id, name, description, price, features, service_ids) VALUES
