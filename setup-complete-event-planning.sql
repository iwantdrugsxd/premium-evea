...
- Email API: `POST /api/email/send`
  - Primary: Gmail SMTP via Nodemailer; fallback: Supabase auth admin sendRawEmail (default service) [[memory:7669236]]
...
- Email: `EMAIL_USER`, `EMAIL_PASS` (for primary SMTP); Supabase works as fallback [[memory:7669236]]
...
- I compiled this from your current pages, APIs, and SQL. If you want, I can export this into `PLAN_EVENT_FLOW.md` in your repo.

- Added a complete, unified doc covering user flow, frontend pieces, API endpoints, DB schema, email, envs, and tests, aligned to current code and your default Supabase email setup.